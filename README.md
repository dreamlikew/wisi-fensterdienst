...
- Ratgeber (`#/ratgeber`): los 8 artículos de fensterdienst.pages.dev/ratgeber, en alemán (original), inglés y español, con el diseño de la antigua página de proyectos (pestañas + tarjetas); cada artículo (`#/ratgeber/artikel#slug`) usa el diseño de detalle de blog de la plantilla (`patchDQ.py`).
